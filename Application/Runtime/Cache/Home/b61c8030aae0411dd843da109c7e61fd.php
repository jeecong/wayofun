			...
			<div class="modal-body" style="width:500px;">
				<?php if(is_array($c)): foreach($c as $key=>$vo): ?><div  style="width:%;background-color:;margin-top:px;">
					<div>
						...
						<a href="#" onclick="look(<?php echo ($vo['c2']); ?>)"><div><img src="/<?php echo ($vo['header']); ?>" height="50" width="50" class="img-circle" alt="用户头像" style="margin-top:20px;margin-right:410px;"></div></a><?php echo ($vo['nickname']); ?>
		...
		<div class="modal-content">
			...
			<div class="modal-body" style="width:800px;">
				<?php if(is_array($b)): foreach($b as $key=>$vo): ?><div  style="width:%;background-color:;margin-top:px;">
					<div>
						<div>
						<a href="#" onclick="look(<?php echo ($vo['uid']); ?>)"><img src="/<?php echo ($vo['header']); ?>" height="50" width="50" class="img-circle" alt="用户头像" style="margin-top:20px;margin-right:700px;"></a><br></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($vo['nickname']); ?>
