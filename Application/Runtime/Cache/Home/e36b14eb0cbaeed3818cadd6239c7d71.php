...
<head>
  ...
  <script type="text/javascript" src="/databasework/Public/index/js/jquery-1.11.3.min.js"></script>-->
    ...
    <!-- 分享 -->
    <link href="/databasework/Public/share/css/share.css" rel="stylesheet" type="text/css">
    
    <!--<script src="/databasework/Public/share/js/jquery-1.8.3.min.js"></script>-->
    <script type="text/javascript" src="/databasework/Public/share/js/share.js"></script>
...
<body class="body " style="background-color:white">
  ...
  <div class="sideShow">
    ...
    <a href=""><img src="/databasework/Public/home/image/4.jpg"></a>

    </div>

    <div style="z-index: 0; display: none;">

    <a href="" class="forTcss"><img id="chbg" src="/databasework/Public/home/image/1.jpg"></a>
    ...
    <img id="chbg" src="/databasework/Public/home/image/8.jpg">
    ...
    <img src="/databasework/Public/home/image/7.jpg"></a>
    ...
    <img src="/databasework/Public/home/image/9.jpg"></a>
...
<script type="text/javascript" src="/databasework/Public/slide/js/jquery.min.js"></script> 

<script type="text/javascript" src="/databasework/Public/slide/js/jquery.im.ui.min.js"></script> 

<script type="text/javascript" src="/databasework/Public/slide/js/jquery.im.index.js"></script>
...
.circle li {
  ...
  background:transparent url(/databasework/Public/slide/images/normal.png) no-repeat center center;
...
.circle li.on {
  ...
  background:transparent url(/databasework/Public/slide/images/active.png) no-repeat center center
    ...
    <div  style="width:100%;background-color:#dddddd;overflow: auto;">
      ...
      <div>
        <div class="content" style="width:60%;background-color:#fff;margin-top:30px;float:left;border-bottom-left-radius:20px;border-bottom-right-radius:20px;margin-left:10%;margin-bottom:50px">
             ...
             <ul class="nav nav-tabs">
               ...
               <li role="presentation" class="active"><a href="<?php echo U('Home/suipian');?>">碎片</a></li>
      ...
      <div class="right1" style="width:18%;height:70px;background-color:white;float:right;margin-top:30px;margin-right:11%">
          <!-- 分享 -->
    ...
    <div class="right1" style="width:18%;height:380px;background-color:white;float:right;margin-top:30px;margin-right:11%">
