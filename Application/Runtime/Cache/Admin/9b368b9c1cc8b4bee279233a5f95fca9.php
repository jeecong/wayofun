...
<head>
    ...
    //删除帖子
      ...
      window.location.href = 'http://localhost/databasework/index.php/Admin/Index/delete?id='+id;
    }
    function passnotes(id){
            // window.location.href = 'http://localhost/databasework/index.php/Home/Home/home';
      window.location.href = 'http://localhost/databasework/index.php/Admin/Index/passnotes?id='+id;
    }
    </script>
                                            ...
                                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="even gradeC">
                                                ...
                                                <td>
                                                    <div class="tpl-table-black-operation">
                                                        <a href="javascript:;" onclick="passnotes(<?php echo ($vo['flag']); ?>)">
                                                            <i class="am-icon-pencil"></i> 通过
                                                        </a>
                                                        <a href="javascript:;" class="tpl-table-black-operation-del" id="" onclick="deletenotes(<?php echo ($vo['flag']); ?>)">
